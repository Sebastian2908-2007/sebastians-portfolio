    ...
    return (
        ...
        <div className="card" >
          ...
          <div className="card-body">
            ...
            This is why I do what I do the programming the freelancing. Because there is nothing better than spending a day in a beautiful place with 
            this company, it doesn't even have to be a beautiful place with them any place will do. 
            </p>
          </div>
       </div>  
        ...
        <div className="d-flex flex-column flex-lg-row">
         <div className="card " >
          ...
          <div className="card-body">
            <p className="card-text">No electricity out here! Who needs it when I've got this beauty!.</p>
          </div>
       </div>  
